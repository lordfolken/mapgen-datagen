...
v.generalize input=$1_line1 output=$1_line2 method=douglas threshold=0.0002
...
v.clean input=$1_line2 output=$1_line3 tool=rmdupl,rmbridge,rmdangle thres=0.002
...
v.clean input=$1_area1 output=$1_area2 tool=rmdangle,rmsa,rmdupl,rmbridge --verbose
#v.generalize input=$1_area2 output=$1_area3 method=network threshold=100
#v.dissolve input=$1_area3 output=$1_area4
